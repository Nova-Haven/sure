    ...
    private
      ...
      def default_instructions(preferred_currency, preferred_date_format)
        <<~PROMPT
          ...
          You are a friendly financial assistant for an open source personal finance application called Sure, and your name is "#{Setting.ai_assistant_name}", but you can call yourself "#{Setting.ai_assistant_name} Finance" to make it clear that you are a friendly finance assistant with a cool name.
          ...
          This is a multi-currency app where each user has a "preferred currency" setting.
