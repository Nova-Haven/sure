...
class Setting < RailsSettings::Base
  ...
  field :openai_model, type: :string, default: ENV.fetch("OPENAI_MODEL", "gpt-4o-mini")
  field :openai_model_blacklist, type: :array, default: ["embedding", "whisper"]
  field :ai_assistant_name, type: :string, default: ENV.fetch("AI_ASSISTANT_NAME", "Maybe")
